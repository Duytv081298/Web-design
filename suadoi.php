				 ...
				 <?php foreach ($rows as $key) { ?>
	 				...
	 				<table  cellspacing="40" cellpadding="0" >
	 					...
	 					<tr>
	 						...
	 						<th colspan="2" > <a href="http://localhost/123/admin.php"><input type="button" value="Trở lại" style=" background-color: #FF7302; text-decoration-color: #FFFFFF; width:25%; height: 30px"></a></th>
	 					</tr>
	 				</table>
	 			</form>
				 <?php } ?>
