				...
				<form action="admin.php" method="POST">
	 				<table  cellspacing="20" cellpadding="0" style="width: 100%; "  >
	 					...
	 					<tr>
	 						...
	 						<th > <a href="http://localhost/123/admin.php"><input type="button" value="Trở lại" style=" background-color: #FF7302; text-decoration-color: #FFFFFF; width:30%; height: 30px"></a></th>
	 					</tr>
